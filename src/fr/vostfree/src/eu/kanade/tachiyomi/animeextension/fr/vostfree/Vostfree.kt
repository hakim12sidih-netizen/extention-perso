...
import extensionsfr.utils.ParsedAnimeDomainSource
...
class Vostfree : ParsedAnimeDomainSource() {
    ...
    override suspend fun getVideoList(episode: SEpisode): List<Video> {
        ...
        return allPlayers.parallelCatchingFlatMap {
            ...
            when (server) {
                "doodstream" -> doodExtractor.videosFromUrl(content, "DoodStream", false)
