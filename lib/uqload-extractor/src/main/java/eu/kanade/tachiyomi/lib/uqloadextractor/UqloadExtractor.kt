...
class UqloadExtractor(private val client: OkHttpClient, private val headers: Headers) {
    fun videosFromUrl(url: String, headers: Headers): List<Video> = videosFromUrl(url, "Uqload")
