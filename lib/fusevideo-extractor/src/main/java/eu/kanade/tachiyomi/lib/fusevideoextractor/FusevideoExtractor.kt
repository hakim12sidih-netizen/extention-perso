...
class FusevideoExtractor(private val client: OkHttpClient, private val headers: Headers) {
    ...
    fun videosFromUrl(url: String, headers: Headers): List<Video> = videosFromUrl(url, "Fusevideo")
    ...
    fun videosFromUrl(url: String, prefix: String = ""): List<Video> {
        return runCatching {
            ...
            playlistUtils.extractFromHls(videoUrl, videoNameGen = { "${prefix}Fusevideo - $it" })
