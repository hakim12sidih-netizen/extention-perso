...
class CdaExtractor(private val client: OkHttpClient, private val headers: Headers) {

    private val json: Json by injectLazy()

    fun videosFromUrl(url: String, headers: Headers, prefix: String = "CDA"): List<Video> = videosFromUrl(url, prefix, headers)
